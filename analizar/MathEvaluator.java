...
/**
 * <i>Mathematic expression evaluator.</i> Supports the following functions: +, -, *, /, ^, %, cos, sin, tan, acos, asin, atan, sqrt, sqr, log, min, max, ceil, floor, abs, neg, rndr.<br> When the getValue() is called, a Double object is returned. If it returns null, an error occured.<p> <pre> Sample: MathEvaluator m = new MathEvaluator("-5-6/(-2) + sqr(15+x)"); m.addVariable("x", 15.1d); System.out.println( m.getValue() ); </pre>
 * @version             1.1
